...
const pl: Record<string, string> = {
	...
	'Already used by "{{name}}" — the bestiary counts both as one.':
		'Już używane przez „{{name}}” — bestiariusz liczy oba jako jeden wpis.',
	'Use {{id}}': 'Użyj {{id}}',
	...
	'Scale to': 'Przeskaluj do',
	Chances: 'Szanse',
	'Multiply every selected chance by this percent': 'Pomnóż każdą zaznaczoną szansę przez ten procent',
	'Multiply every selected count by this percent': 'Pomnóż każdą zaznaczoną liczbę przez ten procent',
	Apply: 'Zastosuj',
	...
	'No monster here has loot to copy.': 'Żaden potwór tutaj nie ma łupów do skopiowania.',
	...
	Sort: 'Sortuj',
	'Chance, rarest last': 'Szansa, najrzadsze na końcu',
	'Item name, A–Z': 'Nazwa przedmiotu, A–Z',
	'Item id, lowest first': 'Id przedmiotu, od najniższego',
	'Count, largest first': 'Liczba, od największej',
	...
	'Ignore cooldown': 'Ignoruj odnowienie',
	...
	'every {{ms}} ms · interval is {{real}} ms': 'co {{ms}} ms · interval to {{real}} ms',
	projectile: 'pocisk',
	impact: 'trafienie',
	'on itself': 'na siebie',
	'{{rate}}/min': '{{rate}}/min',
